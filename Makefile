...
SOURCES = \
	__init__.py \
	sos_client.py \
	sos_client_dialog.py \
	textedit_dialog.py

PLUGINNAME = SOSClient
...
PY_FILES = \
	...
	textedit_dialog.py\
	xmlviewer_dialog.py \
	qgsmaptool_capturespatialoperand.py \
	ui/__init__.py \
	ui/utils.py \
	sos/__init__.py \
	sos/sos.py \
...
UI_FILES = 	ui/sos_client_dialog_base.ui \
		ui/textedit_dialog_base.ui \
		ui/xmlviewer_dialog_base.ui \
		ui/time_widget_base.ui \
		ui/timeperiod_widget_base.ui \
		ui/sosplot_dialog_base.ui

EXTRAS = ui/icon.png metadata.txt

COMPILED_RESOURCE_FILES = ui/resources_rc.py
...
RESOURCE_SRC=$(shell grep '^ *<file' ui/resources.qrc | sed 's@</file>@@g;s/.*>//g' | tr '\n' ' ')
